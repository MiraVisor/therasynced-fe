  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center space-y-4 py-8">
        ...
        <div>
          <h2 className="text-3xl font-poppins font-bold text-charcoal dark:text-white mb-2">
            Booking Confirmed!
          </h2>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="mt-1">
                    {booking.serviceCategories.map((service, index) => (
                      <span key={service.id} className="font-medium text-charcoal dark:text-white">
                        {service.name}
              ...
              <div>
                ...
                <p className="font-mono text-sm text-gray-700 dark:text-gray-300">{booking.id}</p>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      {/* Info Message */}
      <div className="max-w-2xl mx-auto bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
