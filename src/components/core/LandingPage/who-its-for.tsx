...
const audience = [
  {
    ...
    badge: '01',
    title: 'Assessment',
    subtitle: 'Understanding your condition through detailed consultation and diagnosis.',
    bullets: ['Initial evaluation', 'Health history review', 'Goal setting'],
    image: '/images/physio/physiotherapist-helping-female-patient-her-clinic.jpg',
    alt: 'Professional conducting patient assessment',
  },
  {
    id: 2,
    badge: '02',
    title: 'Treatment Plan',
    subtitle: 'Customized exercises, therapies, and recovery goals.',
    bullets: ['Personalized protocols', 'Progress milestones', 'Flexible scheduling'],
    image: '/images/physio/doctor-glues-tepee-athlete-hospital.jpg',
    alt: 'Healthcare professional creating treatment plan',
  },
  {
    id: 3,
    badge: '03',
    title: 'Continuous Support',
    subtitle: 'Regular progress tracking and post-recovery guidance.',
    bullets: ['Ongoing check-ins', 'Plan adjustments', 'Long-term wellness'],
    image: '/images/physio/woman-working-with-personal-trainer.jpg',
    alt: 'Trainer providing continuous support',
  },
];
        ...
        <div className="relative xl:min-h-[750px]">
          ...
          <div className="xl:absolute xl:top-0 xl:left-0 xl:max-w-[600px]  mb-10 xl:mb-0 z-10 text-center lg:text-left ">
            <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-primary tracking-tight leading-[1.1]">
              Our <span className="text-primary/70">3-Step</span> Recovery Process
            </h1>
            <p className="mt-4 sm:mt-6 text-sm xs:text-base sm:text-lg text-gray-600 dark:text-neutral-400 max-w-sm mx-auto lg:mx-0 leading-relaxed">
              We believe recovery is more than treatment — it&apos;s a journey. Our certified
              professionals combine clinical expertise with personalized care.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-6 xl:contents gap-6">
            {/* Card 01 - Top Right */}
            <article className="xl:absolute xl:top-0 xl:right-0 xl:w-[380px] 2xl:w-[420px] group p-4 sm:p-5 rounded-2xl border-2 border-dashed border-primary/30 hover:border-primary/50 transition-all duration-300 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm shadow-lg shadow-primary/5 dark:shadow-primary/10">
          ...
          <div className="xl:absolute xl:bottom-0 xl:right-0 mt-10 xl:mt-0 text-center lg:text-right">
            <Link
