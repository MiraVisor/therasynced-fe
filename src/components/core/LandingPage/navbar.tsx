  ...
  const MobileNavbar = () => (
    <>
      <div className="flex items-center justify-between px-6 py-4 shadow-lg">
        <Link href={'/'}>
          <Image src={'/svgs/next.svg'} alt="logo" width={54} height={54} />
        </Link>
      ...
      {isMenuOpen && (
        ...
        >
          <Link
            ...
            className={`capitalize text-sm ${hash === '#home' ? 'text-primary' : 'text-[#767676]'} transition-colors`}
          >
            home
          </Link>
          <Link
            ...
            className={`capitalize text-sm ${hash === '#about' ? 'text-primary' : 'text-[#767676]'} transition-colors`}
          >
            about us
          </Link>
          <Link
            ...
            className={`capitalize text-sm ${hash === '#services' ? 'text-primary' : 'text-[#767676]'} transition-colors`}
          >
            our services
          </Link>
          <Link
            ...
            className={`capitalize text-sm ${hash === '#pricing' ? 'text-primary' : 'text-[#767676]'} transition-colors`}
          >
            pricing
          </Link>
      ...
      <div className="flex items-center gap-11">
        ...
        <div className="flex gap-6">
          <Link
            ...
            className={`capitalize border-b-2 ${hash === '#home' ? 'text-primary border-b-primary' : 'text-[#767676] border-b-transparent'} text-sm`}
          >
            home
          </Link>
          <Link
            ...
            className={`capitalize border-b-2 ${hash === '#about' ? 'text-primary border-b-primary' : 'text-[#767676] border-b-transparent'} text-sm`}
          >
            about us
          </Link>
          <Link
            ...
            className={`capitalize border-b-2 ${hash === '#services' ? 'text-primary border-b-primary' : 'text-[#767676] border-b-transparent'} text-sm`}
          >
            our services
          </Link>
          <Link
            ...
            className={`capitalize border-b-2 ${hash === '#pricing' ? 'text-primary border-b-primary' : 'text-[#767676] border-b-transparent'} text-sm`}
          >
            pricing
          </Link>
          <ThemeToggle />
