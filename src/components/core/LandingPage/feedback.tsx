  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-mint-light/20 to-transparent pointer-events-none" />
        ...
        <div className="max-w-[1500px] mx-auto flex flex-col items-center gap-8 sm:gap-12 lg:gap-16 relative z-10">
          ...
          >
            <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 leading-[1.1] font-playfair">
              What Our <span className="text-primary">Clients Say</span>
            </h2>
            <p className="text-sm xs:text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed font-open-sans">
          ...
          <motion.div
            ...
            data-aos-duration="800"
          >
            <div className="relative p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-primary/10 via-sage-warm/10 to-mint-light/20 border-2 border-primary/20 shadow-2xl overflow-hidden">
              {/* Decorative Elements */}
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 font-playfair">
                  {featuredTestimonial?.title}
                </h3>
                <p className="text-lg text-gray-700 leading-relaxed mb-8 font-open-sans">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl">
            {otherTestimonials.map((testimonial, idx) => (
              ...
              >
                <div className="relative h-full flex flex-col p-6 rounded-2xl border border-gray-200 bg-white backdrop-blur-sm shadow-sm transition-all duration-300 group-hover:shadow-lg group-hover:border-primary/30 hover:-translate-y-2">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2 line-clamp-1 font-poppins">
                    {testimonial.title}
                  </h3>
                  <p className="text-gray-700 text-sm leading-relaxed mb-4 flex-grow line-clamp-3 font-open-sans">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="font-semibold text-gray-900 text-sm truncate font-poppins">
                        {testimonial.author}
                      </p>
              ...
              {repeatedTestimonials.map((testimonial, idx) => (
                ...
                >
                  <div className="group relative h-full">
                    <div className="relative h-full flex flex-col p-5 sm:p-6 rounded-2xl border border-gray-200 bg-white backdrop-blur-sm shadow-sm transition-all duration-300 group-hover:shadow-lg group-hover:border-primary/30">
                      ...
                      <div className="flex gap-0.5 mb-3">{renderStars(testimonial.rating)}</div>
                      <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 line-clamp-1 font-poppins">
                        {testimonial.title}
                      </h3>
                      <p className="text-gray-700 text-xs sm:text-sm leading-relaxed mb-4 flex-grow line-clamp-2 font-open-sans">
                        {testimonial.description}
                      </p>
                      <div className="h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent mb-4" />
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="font-semibold text-gray-900 text-xs sm:text-sm truncate font-poppins">
                            {testimonial.author}
                          </p>
                          <p className="text-xs text-gray-500 truncate font-inter">
                            {testimonial.handle}
