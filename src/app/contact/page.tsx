      ...
      <section className="relative w-full px-4 sm:px-6 lg:px-8 pt-10 pb-16 lg:pt-14 lg:pb-20 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="max-w-3xl space-y-5">
            ...
            <p className="text-base sm:text-lg text-gray-600 font-open-sans leading-relaxed">
      ...
      <section className="relative w-full px-4 sm:px-6 lg:px-8 py-16 lg:py-20 bg-[#faf9f6]
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            {/* Support Card */}
            <div className="p-7 lg:p-8 rounded-2xl border border-gray-100 bg-white shadow-sm hover:shadow-md hover:border-primary/30 transition-all duration-300 group">
      ...
      <section className="w-full px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <div className="p-7 lg:p-8 rounded-2xl bg-[#faf9f6] border border-gray-100
            ...
            <ul className="text-sm text-gray-600 space-y-3 list-disc pl-5 font-open-sans leading-relaxed">
              <li>
          ...
          <div className="text-center">
            <h3 className="text-sm font-bold text-gray-900 font-poppins mb-5 uppercase tracking-wider">
              Follow us
            </h3>
